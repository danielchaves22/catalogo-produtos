    ...
    <div className={`mb-4 ${className}`} ref={containerRef}>
      ...
      <div className="relative">
        <button
          ...
          onClick={toggle}
          ref={buttonRef}
          className={`flex w-full items-center justify-between gap-2 rounded-md border bg-[#1e2126] px-2 py-1 text-left text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus-visible:border-blue-500 ${
